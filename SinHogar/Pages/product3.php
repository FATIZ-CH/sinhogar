                  ...
                  <span>Quantity: &nbsp;</span><select id="quantity" name="selected" >
                                             ...
                                             <option value="10">10</option>
                                               ...
                                               <br>
                                                ...
                                                <br>
                                                <br>
                                            <input id="aa" type="submit" value="confirmer"  >
...
$insert1 = "INSERT INTO orderproducts (id_product, id_order) VALUES ($id_product, $value1)";
$result2 = mysqli_query($link,$sql1);
if(mysqli_query($link, $insert1)){
			         echo "<p align='center'><span class='text-success'><b></b></span></p>" ;}
 else{ 			      echo "<p align='center'><span class='text-success'><b> The product is already selected, please click to confirm to chose another or to buy</b></span></p>";}
