...
<form class="box" action="inscri.php" method="post">
  <h1>Inscription</h1>
  ...
  <input type="date" name="date_birth" placeholder="date_birth" required>
  
                                                            <div class="col-md-4">
											<select id="countryCode" name="contry" class="form-control" required>
  ...
  <input type="submit" name="" value="Inscription"onclick="Inscription()">
</form>
</section>
<script>
